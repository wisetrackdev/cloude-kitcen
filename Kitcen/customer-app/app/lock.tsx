...
export default function LockScreen() {
  ...
  const triggerBiometricAuth = async () => {
    try {
      ...
      // 1. Check if biometrics hardware exists
      ...
      // 2. Check if biometrics is enrolled
      ...
      // 3. Trigger Biometrics prompt
      const result = await LocalAuthentication.authenticateAsync({
        promptMessage: 'Authenticate to unlock Clude Kitchen',
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Clude Kitchen Locked</Text>
