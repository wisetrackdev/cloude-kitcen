// Centralized API configuration for Cloude Kitchen
// Default port is 5059 based on ASP.NET launchSettings.json

// If running in Android Emulator: use 'http://10.0.2.2:5059'
